...
{
    public class GetUniversityAsyncText
    {
        [Theory]
        [InlineData("test@gmail.com", "LNU", "Faculty of Applied Mathematics")]
        public async void ShouldGetUniversityAsync(string email, string universityName, string facultyName)
        {
            ...
            using (var context = new DatabaseContext(options))
            {
                ...
                var result = await service.GetUniversityAsync(university.Id);
